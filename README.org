...
Configuration without Orderless:
...
recommended to configure [[https://github.com/oantolin/orderless][Orderless]] as =consult--regexp-compiler= in Consult. Affe
requires the ~find~ and ~ripgrep~ command line programs to be available. The
