...
#+html: <a href="https://releases.melpa.org/#/affe"><img alt="MELPA Releases" src="https://releases.melpa.org/packages/affe-badge.svg"/></a>
#+html: <a href="https://snapshots.melpa.org/#/affe"><img alt="MELPA Snapshots" src="https://snapshots.melpa.org/packages/affe-badge.svg"/></a>
...
The package is available on [[https://releases.melpa.org/#/affe][MELPA]] and can be installed using the Emacs package
...
- [[https://github.com/minad/vertico][Vertico]] or [[https://github.com/protesilaos/mct][Mct]]: Vertical completion systems
