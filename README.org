...
complexity will stay sufficiently linear such that the impact on the performance
should be acceptable. However implementing a scoring-based sorting is probably
not feasible since this would require heavier computations in Elisp. But maybe
nativecomp Emacs is a game changer here?
